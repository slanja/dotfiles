...
beautiful.init("/home/slanja/.config/awesome/themes/theme.lua")
        ...
        {
            {
                ...
                valign = "center",
                forced_height = 80,
                widget = wibox.widget.textclock('<span color="#ffffff" font="Motiva Sans 20" font-weight="bold">%H\n %M </span>', 5)
            },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Set up buttons for the layoutbox
    ...
    -- Create a centered taglist widget with custom font
    s.mytaglist = wibox.widget {
        awful.widget.taglist {
            ...
            widget_template = {
                {
                    ...
                    widget = wibox.container.margin, -- Can adjust if needed, remove if no margin
                },
                id     = 'background_role',
                widget = wibox.container.background,
            },
            -- Apply font settings
            style = {
                font   = "Motiva Sans 22",  -- Set the desired font and size
            }
        },
    ...
    local icon_widget = require("icon_widget")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            ".",     function () awful.spawn.with_shell("rofi -modi emoji -show emoji -emoji-format '{emoji}'") end,
              {description = "show emoji keyboard", group = "slanja binds"}),
